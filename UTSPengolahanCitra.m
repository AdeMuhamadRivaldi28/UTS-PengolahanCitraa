...
% Last Modified by GUIDE v2.5 06-May-2021 20:41:26
...
% varargin   command line arguments to UTSPengolahanCitra (see VARARGIN)

% Choose default command line output for UTSPengolahanCitra
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes UTSPengolahanCitra wait for user response (see UIRESUME)
